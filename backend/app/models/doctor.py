...
class Doctor(Base, TimestampMixin):
    ...
    listing_online: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    ...
    patient_reviews = relationship(
        "Review", back_populates="doctor", cascade="all, delete-orphan", lazy="selectin"
    )
...
import backend.app.models.clinic
import backend.app.models.review
import backend.app.models.verification  # noqa: F401
