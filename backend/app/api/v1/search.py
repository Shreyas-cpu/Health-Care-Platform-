...
async def search_catalog(
    specialty: str | None = None, locality: str | None = None, city: str | None = None,
    min_fee: Decimal | None = None, max_fee: Decimal | None = None, gender: str | None = None,
    video_available: bool | None = None, available_today: bool | None = None,
